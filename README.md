...
**What I Discovered:
Retailer Impact: Identified WestPace as a key contributor to total revenue, highlighting the importance of strategic retailer partnerships.
Regional Dominance: The West and Northeast regions showed the highest sales volume, suggesting a strong urban market presence.
Profitability Trends: While Men's Street Footwear leads in sales, the analysis revealed that certain sales methods, like Online, offer competitive operating margins that could be scaled further.
Growth Trajectory: A deep dive into the 2020 vs. 2021 data showed a massive 294% increase in sales, indicating a strong recovery or expansion phase for the brand.

**Technical Process:
Data Cleaning: Used Excel to handle missing values and formatted the "Invoice Date" and "Total Sales" columns for accurate time-series analysis.
